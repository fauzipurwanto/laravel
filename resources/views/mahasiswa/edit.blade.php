                    ...
                    <form action="{{ route('update.mahasiswa', $mahasiswa->id) }}" method="post">
                        ...
                        <div class="form-group">
                            <div class="form-row">
                                ...
                                <div class="col">
                                    <label for="">NPM</label>
                                    <input type="number" name="npm" class="form-control" placeholder="Tambahkan NPM Mahasiswa" value="{{ is_null($mahasiswa) ? '' : $mahasiswa->npm }}">
                                </div>

                                <div class="col">
                                    <label for="">Tempat Lahir</label>
                                    <input type="text" name="tempat_lahir" class="form-control" placeholder="Tambahkan Tempat Lahr" value="{{ is_null($mahasiswa) ? '' : $mahasiswa->tempat_lahir }}">
                                </div>
                            </div>              
                        </div>
                        ...
                        <div class="form-group">
                            <div class="form-row">
                                <div class="col">
                                    ...
                                    <textarea name="alamat" cols="2" rows="3" class="form-control" style="resize: none">
                        ...
                        <div class="container">
                            <div class="form-row float-right">
                                <div class="col">
                                    <button type="submit" class="btn btn-md btn-success font-weight-bold">SIMPAN</button>
                                    <a href="{{ route('mahasiswa') }}" class="btn btn-md btn-warningfont-weight-bold ">BATAL</a>
                                </div>                            
                            </div>
                        </div>
                    </form>
